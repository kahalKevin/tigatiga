...
<div class="service-area ptb-80" id="shop">
            <div class="container">
                <div class="box" action="index.html" method="post">
                        <p class="sp-title">Search Result for : <i><strong>{{ $keyword }}</strong></i></p>
                    <div class="row">
                        ...
                        <div class="col-lg-3 order-2 order-lg-1 mt-all-30">
                            ...
                            <div class="size mb-30" id="size">
                                ...
                                <ul class="size-list sidbar-style">
                                    <form action="/shop/index-search" method="get">
                                    @php 
                                        $input = Input::get();
                                    @endphp
                                    ...
                                    @if($input != null)
                                        @foreach($input as $key => $val)
                                            @if($key != 'sizeIndex')                                        
                                                @if($key == 'priceFrom' || $key == 'priceTo' || $key == 'page' || $key == 'searchItem')
                            ...
                            <div class="size mb-30" id="price">
                                ...
                                <ul class="size-list sidbar-style">
                                    <li class="form-check">
                                        <div class="row">
                                            <form class="price" action="/shop/index-search" method="get">
                                                @php 
                                                    $input = Input::get();
                                                @endphp
